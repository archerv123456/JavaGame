...
public class Game extends Canvas implements Runnable{
	...
	private void render() {
		...
		if(gameState == STATE.GameP4 || gameState == STATE.PvPP4) {
			...
			hud4.render(g);
			handler.render(g);
		}else if(gameState == STATE.Menu || gameState == STATE.End || gameState == STATE.SelectP1 || gameState == STATE.SelectP2 || gameState == STATE.SelectP4 || gameState == STATE.EndPvP || gameState == STATE.PlayerNum || gameState == STATE.PvPPlayerNum || gameState == STATE.PvPP2Select || gameState == STATE.PvPP4Select || gameState == STATE.Help) {
			menu.render(g);
			handler.render(g);
